...
type Response struct {
	...
	UsableTimes          uint32   `protobuf:"varint,2,opt,name=usableTimes,proto3" json:"usableTimes,omitempty"`
	ExpireDate           uint64   `protobuf:"varint,3,opt,name=expireDate,proto3" json:"expireDate,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Response) GetCharge() float64 {
	if m != nil {
		return m.Charge
	}
	return 0
...
func (m *Response) GetUsableTimes() uint32 {
	if m != nil {
		return m.UsableTimes
	}
	return 0
}

func (m *Response) GetExpireDate() uint64 {
	if m != nil {
		return m.ExpireDate
	}
	return 0
...
var fileDescriptor_93258b77978a8f53 = []byte{
	...
	,
}
